	...
	public ConvexHullGUI() {
		...
		genPoints.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				myPoints.add(new Point2D.Double(150, 100));
				myPoints.add(new Point2D.Double(250, 100));
				myPoints.add(new Point2D.Double(100, 200));
				myPoints.add(new Point2D.Double(200, 200));
//                points = myPoints;
